...
import { scrollToElement, checkElementCanScroll, arrayFilterUnique, parseDateAndTime } from '../../../utils/utils';
...
const ArticlesSlideshowLogic = () => {
    ...
    const displayLoader: boolean = false;
    ...
    */
    ...
    const buildArticleBox = (article: ArticleType, index: number) => {
        ...
        return (
            <Link href={`articles/` + article.id} className={styles} key={uuid()}>
                {
