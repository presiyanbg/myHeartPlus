    ...
    return (
        <>
            <div className="space-y-2 text-center mb-3">
                <h1 className="font-bold text-foreground text-2xl">Security and privacy</h1>
                <p className="text-muted-foreground">Update your password and read our GDPR policy</p>
            </div>
                ...
                <CardBody>
                    <Accordion>
                        ...
                        <AccordionItem title="Privacy Policy">
                            <div className="text-sm privacy-policy-intro">
