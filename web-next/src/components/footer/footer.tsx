    ...
    return (
        <div className="w-full">
            <div className="md:w-34 w-screen lg:w-10/12 xl:w-8/12 mx-auto mt-lg p-3 flex">
                ...
                <div className="px-3">
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Accusamus dolor illo voluptates facilis consequatur quia iste optio exercitationem repudiandae, dolores illum nemo ipsa quibusdam tempora temporibus quis corporis. Non, molestias.</p>
                </div>
