...
const CustomSelect = (props: Props) => {
    ...
    return (
        <div className="custom-select" key={id} onBlur={() => toggleListOpen(false)}>
            <div className="form-floating custom-select__input">
                <input type="text"
                ...
                <div className="custom-select__input__icon">
            ...
            <div className="custom-select__list">
                {
                    listOpen && !!listData?.length && (
                        <ul className="custom-select__list__group custom-select__list__group-flush">
                            {
                                listData.map((row: any) => {
                                    return (
                                        <li key={uuid()}
                                            className="custom-select__list__group__item"
